---
name: aionify-pull-request
description: >
  Publishes the current local branch to remote, creates a pull request against
  main, and enables squash auto-merge after committing pending changes,
...
- The current directory must be inside the Aionify git repository.
