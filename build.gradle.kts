...
dependencies {
    ...
    e2eTestImplementation("com.microsoft.playwright:playwright:1.62.0")
    e2eTestImplementation("org.junit.jupiter:junit-jupiter:6.1.3")
    e2eTestImplementation("org.junit.platform:junit-platform-launcher:6.1.3")
}
