      ...
      settings: {
        ...
        apiToken: {
          ...
          deleteConfirm: {
            ...
            message:
              "Are you sure you want to delete your API access token? This will disable API access until you generate a new token.",
            confirm: "Delete",
            cancel: "Cancel",
          },
        },
      ...
      settings: {
        ...
        apiToken: {
          ...
          deleteConfirm: {
            ...
            message:
              "Ви впевнені, що хочете видалити ваш API токен доступу? Це вимкне доступ до API, поки ви не згенеруєте новий токен.",
            confirm: "Видалити",
            cancel: "Скасувати",
          },
        },
