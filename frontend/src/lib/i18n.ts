  ...
  en: {
    translation: {
      ...
      activation: {
        ...
        validating: "Validating your activation link...",
        noToken: "No activation token provided",
        invalidToken: "This activation link is invalid or has expired",
        contactAdmin: "Please contact your system administrator for a new activation link.",
  ...
  uk: {
    translation: {
      ...
      activation: {
        ...
        subtitle: "Встановіть пароль для активації облікового запису",
        validating: "Перевірка посилання активації...",
        noToken: "Токен активації не надано",
        invalidToken: "Це посилання активації недійсне або закінчилося",
        contactAdmin: "Будь ласка, зверніться до системного адміністратора для отримання нового посилання активації.",
