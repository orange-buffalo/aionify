...
export function TagsPage() {
  ...
  return (
    <PortalLayout testId="tags-page">
      <div className="p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground" data-testid="tags-title">{t("tags.title")}</h1>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-[100px]">{t("tags.table.count")}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {tags.map((tagStat) => (
